...
const Armony: FC = () => {
	...
	return (
		<section
			className="h-screen items-center flex px-4 sm:px-7 justify-center"
			id="armony-of-the-stars"
			data-testid="armony-of-the-stars"
		>
			<div
				className="rounded-xl container h-72 sm:h-96 lg:h-[30rem] xl:h-[33rem] w-96 sm:w-2/3 md:w-3/5 lg:w-4/6 shadow-2xl flex justify-center items-center bg-transparent overflow-hidden"
				ref={parentRef}
			>
				<div
					id="canvas"
